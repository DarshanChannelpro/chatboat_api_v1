...
class Main extends Controller
{
    ...
    public function start($code)
    {
        ...
        try {
            setcookie("accessTokenResult",$accessTokenResult['access_token'], time() + (86400 * 30), "/");
       ...
       //Step 2 - Debug the token, get the shared WABID
        ...
        try {
            ...
            return response()->json(['error' => 'Error getting share WABAID'], 400);
        }
        ...
        try {
            ...
            return response()->json(['error' => 'Error getting phone number'], 400);
        }
        ...
        try {
            ...
            if($phoneRegisterResult){
               //OK, continue with the registration
                ...
                return response()->json(['error' => 'Error registering phone number'], 400);
            }
        } catch (\Exception $e) {
            return response()->json(['error' => 'Error registering phone number'], 400);
        }
